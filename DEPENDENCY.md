...
**Network stats:** 544 `related_skills` cross-references across 210 skills (2 skills are standalone with no `related_skills` entries).
...
All 544 `related_skills` references in the repository resolve to existing in-repo skills. Verified against 210 unique skill names.
