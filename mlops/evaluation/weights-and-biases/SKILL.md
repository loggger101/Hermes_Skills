...
description: "W&B: log ML experiments, sweeps, registry, dashboards"
version: 1.0.1
...
prerequisites:
  commands: [python -c "import wandb"]
  setup_verification: "python -c 'import wandb; print(wandb.__version__)' prints a version"
required_commands:
  - python
metadata:
  hermes:
...
W&B: log ML experiments, sweeps, registry, dashboards
