...
prerequisites:
  commands: [python -c "import llama_cpp"]
  setup_verification: "python -c 'import llama_cpp; print(llama_cpp.__version__)' prints a version"
required_commands:
  - python
metadata:
  hermes:
...
1. Search for candidate repos on the Hub:
   - Base: `https://huggingface.co/models?library=llama.cpp&sort=trending`
...
```text
https://huggingface.co/models?library=llama.cpp&sort=trending
https://huggingface.co/models?search=<term>&library=llama.cpp&sort=trending
https://huggingface.co/models?search=<term>&library=llama.cpp&num_parameters=min:0,max:24B&sort=trending
https://huggingface.co/<repo>?local-app=llama.cpp
https://huggingface.co/api/models/<repo>/tree/main?recursive=true
...
- **Example llama.cpp search**: https://huggingface.co/models?num_parameters=min:0,max:24B&library=llama.cpp&sort=trending
- **License**: MIT
