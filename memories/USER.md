...
§
Works on Hermes_Skills repo (round-43 + plugin-env sync done @ HEAD b2eb15f, 2026-09-20; resume protocol = fresh star sweep + gh api drift recon on pinned sources) and General_Research source-anchoring rounds for spacecost/economicspace (standing multi-round task, R35 verified-unregistered as of 2026-09-19).
§
