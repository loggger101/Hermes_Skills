...
- ✅ All `related_skills` references resolve to existing in-repo skills — 529 cross-references across 206 skills (see [DEPENDENCY.md](./DEPENDENCY.md))
