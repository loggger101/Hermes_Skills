...
description: "Windows desktop E2E testing with pywinauto + UI Automation."
version: v0.1.0
...
metadata:
  hermes:
    tags: [testing, e2e, pywinauto, ui-automation, windows-desktop]
...
End-to-end test automation for Windows native desktop apps (WPF, WinForms, Win32/MFC, Qt) built on **pywinauto** with the UI Automation backend. Ships a full page-object skeleton, three tiers of process isolation, flaky-test handling, CI wiring for `windows-latest`, and a screenshot-mode fallback for controls UIA cannot reach.
...
- [test-driven-development](../test-driven-development/SKILL.md) — general test discipline: red-green-refactor at pre-agreed seams.
