...
metadata:
  hermes:
    ...
    related_skills: [delegate-task, mattpocock-to-tickets, mattpocock-multi-agent-code-review, mattpocock-using-git-worktrees, mattpocock-finishing-a-development-branch, requesting-code-review]
---
...
- A clear plan or list of tasks to implement
- An isolated worktree (load `skill_view(name='mattpocock-using-git-worktrees')`)
- `delegate_task` available for spawning subagents
- A ledger file to track completions
