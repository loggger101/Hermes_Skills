...
metadata:
  hermes:
    ...
    related_skills: [test-driven-development, plan, mattpocock-subagent-driven-development, failure-signal-audit]
...
When fixing bugs:
1. Write a test that reproduces the bug (RED) — load `skill_view(name='test-driven-development')`
