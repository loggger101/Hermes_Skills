...
### 3b. Assess decision quality

Not every statement in notes is a decision. Classify each candidate decision:

| Type | Meaning | Action |
|---|---|---|
| **Decided** | Explicit agreement recorded ("we decided", "the plan is", "confirmed") | Extract as decision with the stated outcome |
| **Proposed** | One person suggested it; no agreement recorded | List as open proposal, not a decision |
| **Assumed** | Presented as settled but no decision marker exists | Flag as unverified — confirm with participants before treating as decided |
| **Contradicted** | Two participants stated different things | Record both positions; mark as unresolved |

Done when every extracted decision is either explicitly recorded in the notes, or explicitly flagged as needing confirmation.
