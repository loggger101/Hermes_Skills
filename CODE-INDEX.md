...
Flat index of all **142 code files** (32,921 lines total) in this second brain — one line each, grep-friendly.
...
- `tools/verify-all.py` (repo tooling, python, 198 lines) — Run every health gate in this repo and report one verdict

---
*142 code files: 102 scripts, 7 shared helpers, 14 tests. Keep in sync when adding/removing/renaming code (conventions: README 'Verification' section + tools/audit-skills.py).*
