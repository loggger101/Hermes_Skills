...
- **Default clumping** — falling into the 3 AI-default looks (cream+terracotta, black+acid green, broadsheet grayscale) instead of making a specific choice for this brief
- **Over-decoration** — every section animated, every corner rounded, every edge shadowed. Ask: does this serve the subject or just fill space?
- **Vague hero** — opening with something generic rather than the most characteristic aspect of the subject
...
- [ ] The color palette (4–6 named hex values) is chosen, not defaulted
- [ ] Typography uses 2+ deliberately paired faces, not the same family throughout
- [ ] The hero element reflects the subject's distinctive character
- [ ] Every decorative element serves a purpose (or has been removed via the Chanel test)
- [ ] The design reads as "made for this brief" — not "made from any brief"
