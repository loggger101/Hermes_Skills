...
- If `himalaya --version` doesn't print, install it (see Prerequisites) before any mailbox operation. The CLI is the only dependency — no API keys, no Hermes-specific integration beyond the terminal tool.
