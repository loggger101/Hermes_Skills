...
- User wants a production component — load `skill_view(name='claude-design')` or build it properly
- User wants a polished one-off HTML artifact (landing page, deck) — load `skill_view(name='claude-design')`
- User wants a diagram — load `skill_view(name='excalidraw')` / `skill_view(name='architecture-diagram')`
